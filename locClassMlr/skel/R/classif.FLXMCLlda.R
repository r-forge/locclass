#' @rdname makeRLearner
#' @method makeRLearner classif.FLXMCLlda
#' @S3method makeRLearner classif.FLXMCLlda
makeRLearner.classif.FLXMCLlda = function() {
	makeRLearnerClassif(
		cl = "classif.FLXMCLlda",
		package = "locClass",
...
#' @method predictLearner classif.FLXMCLlda
#' @S3method predictLearner classif.FLXMCLlda
predictLearner.classif.FLXMCLlda = function(.learner, .model, .newdata, ...) {
