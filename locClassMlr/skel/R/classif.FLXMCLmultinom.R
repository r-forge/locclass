#' @rdname makeRLearner
#' @method makeRLearner classif.FLXMCLmultinom
#' @S3method makeRLearner classif.FLXMCLmultinom
...
#' @rdname trainLearner
#' @method trainLearner classif.FLXMCLmultinom
#' @S3method trainLearner classif.FLXMCLmultinom
trainLearner.classif.FLXMCLmultinom = function(.learner, .task, .subset, .weights, ...) {
...
#' @S3method predictLearner classif.FLXMCLmultinom
