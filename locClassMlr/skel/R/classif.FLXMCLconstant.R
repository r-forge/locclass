#' @rdname makeRLearner
#' @method makeRLearner classif.FLXMCLconstant
#' @S3method makeRLearner classif.FLXMCLconstant
makeRLearner.classif.FLXMCLconstant = function() {
	makeRLearnerClassif(
		cl = "classif.FLXMCLconstant",
		package = "locClass",
...
#' @rdname trainLearner
#' @method trainLearner classif.FLXMCLconstant
#' @S3method trainLearner classif.FLXMCLconstant
trainLearner.classif.FLXMCLconstant = function(.learner, .task, .subset, .weights, ...) {
...
#' @S3method predictLearner classif.FLXMCLconstant
predictLearner.classif.FLXMCLconstant = function(.learner, .model, .newdata, ...) {
