...
#'	 specified.) \code{TRUE} if only the \code{k} nearest neighbors recieve a positive 
...
#'   \item{method}{The method for scaling the weighted covariance matrices, either 
#'  	\code{"unbiased"} or \code{"ML"}.}
#'   \item{type}{}
#'   \item{kernel}{}
#'   \item{cost}{}
#'   \item{degree}{}
