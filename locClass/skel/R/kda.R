...
#' (see \code{\link[=generatewf]{wfs}}) and pass them to \code{kda}. 
#'
...
#'	  is fixed.}
#'  \item{variant}{(Only if \code{wf} is a string or if one of the weight functions documented in \code{\link[=generatewf]{wfs}} is used, for internal use only). 
#'	  An integer indicating which weighting scheme is implied by \code{bw}, \code{k} and \code{nn.only}.}
#'  \item{call}{The (matched) function call.}
#'
#' @references 
#' Devroye, L., Györfi, L. and Lugosi, A. (1996), A Probabilistic Theory of Pattern Recognition. 
#' Springer, New York.
#'
...
#' @rdname kda
#' @method kda data.frame
#'
#' @S3method kda data.frame
